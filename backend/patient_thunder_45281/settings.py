"""
Django settings for patient_thunder_45281 project.
...
ROOT_URLCONF = 'patient_thunder_45281.urls'
...
WSGI_APPLICATION = 'patient_thunder_45281.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "patient_thunder_45281 API",
    "DESCRIPTION": "API documentation for patient_thunder_45281 App",
    "VERSION": "v1",
}
